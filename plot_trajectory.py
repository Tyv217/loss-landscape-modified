...
if __name__ == '__main__':
    ...
    if args.dir_file1:
        ...
        dir_file1 = setup_PCA_directions(args, model_files1, w1, s1)
    if args.dir_file2:
        dir_file2 = args.dir_file2
    else:
        dir_file2 = setup_PCA_directions(args, model_files2, w2, s2)
    ...
    plot_2D.plot_trajectory(proj_file1, dir_file1, savefig=False)
    plot_2D.plot_trajectory(proj_file2, dir_file2)